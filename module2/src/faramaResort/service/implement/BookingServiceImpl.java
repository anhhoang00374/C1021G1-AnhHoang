...
import faramaResort.models.facility.Facility;
import faramaResort.models.facility.House;
import faramaResort.models.facility.Room;
import faramaResort.models.facility.Villa;
import faramaResort.models.person.Customer;
import faramaResort.service.IBookingContact;
import faramaResort.utils.SortByStartDay;
...
public class BookingServiceImpl implements IBookingContact {
    static String PATH_CUSTOMER = "/Users/nguyenhoang/Desktop/codegym/C1021G1/module2/src/faramaResort/data/customers.csv";
...
//
        //bookingSet.add(new Booking("087411","2/2/2022","2/2/2022","gol471", "Home-1","Deluxe","2021-12-31"));
        //bookingSet.add(new Booking("087411","2/2/2022","2/2/2022","gol471", "Home-2","Deluxe","2021-12-31"));
    ...
    void readRoom(){
        final String PATH_ROOM = "/Users/nguyenhoang/Desktop/codegym/C1021G1/module2/src/faramaResort/data/room.csv";
        try {
    ...
    void readHouse(){
        final String PATH_HOUSE = "/Users/nguyenhoang/Desktop/codegym/C1021G1/module2/src/faramaResort/data/house.csv";
        try {
    ...
    @Override
    public void add() {
        //integerSet.add(new Booking1("ewewe","ewewe","ewewe","ewewe","ewewe","ewewe","ewewe"));
        //integerSet.add(new Booking1("dddd","dddd","dddd","dddd","dddd","dddd","dddd"));
...
//        display();
//        String bookingId, String startDate, String endDate, int idCustomer,
//        String serviceName, String serviceType,long bookingTime
        ...
        do{
            ...
            if(checkDate(endDate)){
                ...
                if(endDayToMilliseconds-starDayToMilliseconds<0){
                   ...
                   if(rentType.toLowerCase().equals("year")){
                       if(year<1){
    ...
    public void display() {
        ...
        if(bookingList.size()>0){
            Collections.sort(bookingList,new SortByStartDay());
...
//            }
            ...
            System.out.println("\t\t\t\t-----------------------------------------------------------------------------------------------------------------------------------------------");
            System.out.println();
            //String bookingId, String startDate, String endDate, String idCustomer,
...
//        for(Facility service: facilityList){
...
//        }
    ...
    static void writeMaintain(){
        String PATH = "/Users/nguyenhoang/Desktop/codegym/C1021G1/module2/src/faramaResort/data/maintain.csv";
        try {
    ...
    public  List<Facility> readMaintain(){
        ...
        try {
            FileReader fileReader = new FileReader("/Users/nguyenhoang/Desktop/codegym/C1021G1/module2/src/faramaResort/data/maintain.csv");
            BufferedReader bufferedReader = new BufferedReader(fileReader);
            String data = null;
            while((data= bufferedReader.readLine())!=null){
                ...
                if(dataArr[0].toLowerCase().contains("svvl")){
                    Villa villa = new Villa(dataArr[0],dataArr[1],Double.parseDouble(dataArr[2]),Integer.parseInt(dataArr[3]),
                            Integer.parseInt(dataArr[4]), dataArr[5],dataArr[06],Double.parseDouble(dataArr[7]),Integer.parseInt(dataArr[8]));
                    facilityList.add(villa);
