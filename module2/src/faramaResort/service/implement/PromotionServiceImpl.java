...
import faramaResort.models.agreement.CustomerByYear;
import faramaResort.models.agreement.Voucher;
...
public class PromotionServiceImpl {
    ...
    public void readFacility(){
     ...
     void readCustomer() {
         customerList.clear();
         File readCustomerProfile = new File("/Users/nguyenhoang/Desktop/codegym/C1021G1/module2/src/faramaResort/data/customers.csv");
...
//                System.out.println(customerByYear);
//            }
    ...
    public void displayCustomersGetVoucher(){
        ...
        Collections.sort(bookingListSortedByTime,new SortByTimeBooking());
        ...
        if(quantityOfCustomers>0){
            ...
            for(Booking booking: bookingListSortedByTime){
                //String name, String customerId, String voucher
